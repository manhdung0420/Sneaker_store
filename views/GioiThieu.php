                ...
                <div class="row">
                    <div class="col-lg-6 col-md-5">
                        <div class="overview-img text-center img-hover_effect">
                            <a href="#">
                                <img class="img-full" src="assets/images/slider/1-6.jpg" alt="Kenne's About Us Image">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-7 d-flex align-items-center">
                        <div class="overview-content">
                            <h2>Chào mừng bạn đến với  <span>Sneaker Store</span> !</h2>
                            <p class="short_desc">Chúng tôi cung cấp những sản phẩm giày đẹp, chất lượng cao, với thiết kế đa dạng và phong cách.
                                Chúng tôi cam kết mang đến cho bạn những đôi giày thoải mái, bền bỉ và hợp xu hướng. 
                                Tại Sneaker Store, mỗi bước đi của bạn sẽ trở nên tự tin và nổi bật!</p>
                            <div class="kenne-about-us_btn-area">
                                <a class="about-us_btn" href="<?= BASE_URL . '?act=danh-sach-san-pham' ?>">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row" style="justify-content: center;">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member">
                            ...
                            <div class="team-content text-center">
                                <h3>Đỗ Mạnh Dũng</h3>
                                <p>Lập trình viên</p>
                                <a href="#">dungdmph49130@gmail.com</a>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member">
                            <div class="team-thumb img-hover_effect">
                                <a href="#">
                                    <img src="assets/images/about-us/team/2.JPG" height="320px" alt="Our Team Member">
                                </a>
                            </div>
                            <div class="team-content text-center">
                                <h3>Phạm Thị Ngọc Diệp</h3>
                                <p>Lập trình viên</p>
                                <a href="#">diepptnph45159@fpt.edu.vn</a>
                                <div class="kenne-social_link">
                                    <ul>
                                        <li class="facebook">
                                            <a href="https://www.facebook.com/" data-bs-toggle="tooltip" target="_blank" title="Facebook">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-member">
                            ...
                            <div class="team-content text-center">
                                ...
                                <p>Lập trình viên</p>
                                <a href="javascript:void(0)">quannmph45405@fpt.edu.vn</a>
                                <div class="kenne-social_link">
                                    <ul>
                                        <li class="facebook">
                                            <a href="https://www.facebook.com/" data-bs-toggle="tooltip" target="_blank" title="Facebook">
